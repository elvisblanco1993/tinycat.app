<div x-data="setupEditor(
    ...
    <div class="flex w-full border border-zinc-300 dark:border-zinc-700 border-b-0 dark:text-zinc-300 divide-x divide-zinc-300 dark:divide-zinc-700 bg-zinc-100 dark:bg-zinc-900 rounded-t-lg">
        ...
        <button type="button" class="flex justify-center p-2 transition hover:bg-zinc-200 dark:hover:bg-zinc-700 w-10 dark:bg-zinc-900"
            @click="toggleLink()">
            <x-svg class="w-4 h-auto" svg="link" />
        </button>
    </div>
    <div x-ref="editor" autofocus class="min-h-24 prose prose-sm dark:prose-invert prose-h2:my-0 prose-p:my-0 max-w-5xl border border-zinc-300 shadow-xs rounded-b-lg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300"></div>
</div>
