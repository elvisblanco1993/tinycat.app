...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-blue-400 dark:border-blue-600 text-sm font-medium leading-5 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out'
