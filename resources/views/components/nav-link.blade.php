...
$classes = ($active ?? false)
            ? 'cursor-pointer inline-flex items-center space-x-1 text-sm font-semibold leading-5 text-zinc-900 dark:text-zinc-100 focus:outline-hidden focus:border-blue-700 transition duration-150 ease-in-out'
