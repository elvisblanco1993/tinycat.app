<div>
    ...
    <x-dialog-modal wire:model="modal">
        <x-slot name="title">{{ __("Moving \"$currentItem->name\"") }}</x-slot>
        <x-slot name="content">
            <ul>
                <li class="flex items-center justify-between py-1 px-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-700">
