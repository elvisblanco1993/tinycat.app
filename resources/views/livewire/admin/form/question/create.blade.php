<div>
    <div x-data="{ open: false }" class="flex justify-center">
        ...
        <div
            ...
            x-anchor.offset.10="$refs.addbtn"
            class="w-80 text-sm text-zinc-700 dark:text-zinc-200 bg-white dark:bg-zinc-800 rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-700 shadow-lg"
        >
            <x-block-option wire:click="save('{{ $types::NAME }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
            ...
            <x-block-option wire:click="save('{{ $types::PHONE }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            ...
            <x-block-option wire:click="save('{{ $types::EMAIL }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            ...
            <x-block-option wire:click="save('{{ $types::URL }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            ...
            <x-block-option wire:click="save('{{ $types::FILE }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            ...
            <x-block-option wire:click="save('{{ $types::SHORTTEXT }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            ...
            <x-block-option wire:click="save('{{ $types::LONGTEXT }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            ...
            <x-block-option wire:click="save('{{ $types::SELECT }}')">
                <div class="size-6 flex items-center justify-center bg-zinc-100 dark:bg-zinc-800 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
