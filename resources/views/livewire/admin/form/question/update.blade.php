<div>
    <div class="rounded-lg overflow-hidden hover:bg-slate-100 dark:hover:bg-slate-800 group transition-all">

        <button x-cloak wire:sortable.handle class="w-full text-transparent group-hover:text-slate-700 dark:group-hover:text-slate-300">
