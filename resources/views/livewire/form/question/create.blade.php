<div>
    <div x-data="{ open: false }" class="flex justify-center">
        ...
        <div
            ...
            class="w-80 text-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-lg"
        >
            <x-block-option wire:click="save('{{ $types::NAME }}')">
                <div class="size-6 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-md">
