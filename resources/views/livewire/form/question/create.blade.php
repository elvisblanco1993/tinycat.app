<div>
    <div x-data="{ open: false }" class="flex justify-center">
        ...
        <div
            ...
            class="w-80 text-sm text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700 shadow-lg"
        >
            <x-block-option wire:click="save('{{ $types::NAME }}')">
                <div class="size-6 flex items-center justify-center bg-slate-100 dark:bg-slate-800 rounded-md">
