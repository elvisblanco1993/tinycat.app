<div>
    <div class="rounded-lg overflow-hidden hover:bg-gray-200 dark:hover:bg-gray-800 group transition-all">
        ...
        <button x-cloak wire:sortable.handle class="w-full text-transparent group-hover:text-gray-700 dark:group-hover:text-gray-300">
            <div class="block w-full px-4 py-1 hover:bg-gray-300 dark:hover:bg-gray-700 transition-all">
