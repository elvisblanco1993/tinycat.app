    ...
    <div class="py-6 max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 dark:text-white rounded-lg shadow overflow-hidden">
            <div class="p-4">
                ...
                <div @class(["mt-2 text-gray-500 dark:text-gray-300 flex items-center space-x-4 text-sm" => ($client->phone || $client->billing_email)])>
                    @if ($client->phone)
                    ...
                    @endif
                    @if ($client->email)
                        <a href="mailto:{{$client->billing_email}}" class="flex items-center space-x-1 hover:text-indigo-600 dark:hover:text-white transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
            ...
            <div class="p-4 border-t-2 border-gray-100 dark:border-gray-700"></div>
        </div>
    </div>
</div>
