<div>
    ...
    <div class="mt-3 max-w-full mx-auto px-4 sm:px-6 lg:px-8 sm:flex items-center justify-between">
        <div class="font-medium text-slate-700 dark:text-white">{{ $request->ulid }}</div>

        <div class="mt-3 sm:mt-0 flex items-center space-x-3">
            <div class="inline-flex items-center px-2 py-1 bg-slate-100 dark:bg-slate-700 rounded-full text-xs dark:text-white">
    ...
    <div class="block mt-3 max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-slate-800 px-4 py-6 rounded-lg shadow overflow-hidden">
