        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                ...
                @unless (Auth::user()->is_client)
                    ...
                    <span class="inline-flex items-center space-x-1 text-sm font-semibold leading-5 text-zinc-500">|</span>
                    ...
                    <x-nav-link href="{{ route('audience.index') }}" :active="request()->routeIs('audience.*')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
                ...
                @else
                    ...
                    <x-nav-link href="{{ route('client.file.index', ['client' => Auth::user()->ownedClient]) }}" :active="request()->routeIs('client.file.index')">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-hidden focus:border-zinc-300 transition">
...
{{-- <nav class="hidden fixed md:block md:h-full md:w-72 bg-zinc-100 dark:bg-zinc-800 md:py-6 px-4 border-r dark:border-r-zinc-700">
    ...
    <div class="hidden md:block mt-6 font-medium text-zinc-500">
        ...
        @else
            <x-sidenav-link href="{{ route('client.file.index', ['client' => Auth::user()->ownedClient]) }}" :active="request()->routeIs('client.file.index')">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
                    <path d="M3.75 3A1.75 1.75 0 0 0 2 4.75v3.26a3.235 3.235 0 0 1 1.75-.51h12.5c.644 0 1.245.188 1.75.51V6.75A1.75 1.75 0 0 0 16.25 5h-4.836a.25.25 0 0 1-.177-.073L9.823 3.513A1.75 1.75 0 0 0 8.586 3H3.75ZM3.75 9A1.75 1.75 0 0 0 2 10.75v4.5c0 .966.784 1.75 1.75 1.75h12.5A1.75 1.75 0 0 0 18 15.25v-4.5A1.75 1.75 0 0 0 16.25 9H3.75Z" />
                </svg>
                <span>{{ __("Files") }}</span>
